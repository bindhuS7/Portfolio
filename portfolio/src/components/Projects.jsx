...
const Projects = () => {
  return (
     ...
     <Box sx={{  backgroundColor: "transparent", height: "65vh", display: 'flex', justifyContent: "space-between", flexDirection: "column", padding: "2% 2% 0% 2%", gap:2}}>
            <Typography sx={primaryHead}>Projects </Typography>

           <Box sx={{height:"35%",backgroundColor: "transparent", display: 'flex', justifyContent: "space-around", alignContent: "center", }}>
             <Box sx={{ backgroundColor: "transparent", width:"45%",display: "flex", flexDirection: "column", justifyContent: "flex-start", }}>
                <Typography sx={secondaryHead}gap={2}>Connected School ERP System </Typography>
...
Implemented sophisticated validation logic that successfully reduced data entry errors by 50%. Through close collaboration with 5+ key stakeholders, the platform achieved an impressive 99.5% uptime in production environments. </Typography>
             ...
             <Box sx={{height:"45%", backgroundColor: "transparent", width:"100%",display: "flex", flexDirection: "column", justifyContent: "flex-start", pl: 4,}}>
                ...
                <Typography sx={normalText}>Building a Netflix-like streaming platform with Spring Boot microservices. Developed backend services for user engagement tracking (likes, favorites, views). Implemented recommendation algorithm analyzing 10,000+ user interactions. Designed and integrated UI for Favorites and Discovery pages with Redux state management. Engineered real-time updates with 99.9% API availability. </Typography>
            </Box>
   </Box>
  )
}
